    ...
    <div class="container wow fadeInUp delay-03s">
      <div class="row">
        <div class="logo text-center">
          ...
          <h2>We Are Creating Something New!! Comming Soon</h2>
        </div>

<!--         <div id="countdown" data-wow-delay=".3s" data-date="Dec 26, 2016 06:00:00"></div> -->
        <h2 class="subs-title text-center">Sign now to get access to Certus version-0.1!!!</h2>
...
<!--               <li>
              ...
              <li>
                <a href="https://www.instagram.com/certus.thinking/"><i class="fa fa-instagram"></i></a>
              </li>
            </ul>
          </div>
        </div>
