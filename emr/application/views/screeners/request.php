        ...
        <div class="col-md-12 col-sm-12 col-xs-12">     
            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <div class="col-xs-6" id="changeshift">
                        <?php echo form_open('request/add'); ?>
                            <input type="hidden" class="form-control" name="timeoffType" value="Request Shift Change">
                            <fieldset>
                                <legend for="919003939">Request Shift Change</legend>
                                <div class="form-group">
                            ...
                            <div class="x_content">
                                ...
                                <div class="col-sm-6">
                                    <tbody>
                                        <fieldset class="form-group">
                                            Start Date<input id="start_date" class="form-control" type="date" name="start_date2" value="date" >
                                        </fieldset>
                                    </tbody>
                                </div>
